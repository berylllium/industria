...
use ash::{
    ...
    vk::{self, DebugMarkerMarkerInfoEXT}, Device, Entry, Instance,
};
use std::{
    ffi::{CStr, CString},
};
...
impl Renderer {
    ...
    fn create_instance(entry: &Entry, window: &Window) -> Instance {
        ...
        let (layer_names, layer_names_ptr) = get_layer_names_and_pointers();
    ...
    fn is_device_suitable(
        ...
        let is_swapchain_suitable = {
            let details = SwapchainSupportDetails::query(device, surface, surface_khr);
